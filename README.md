...
## 🧑‍💻 Обо мне
Студентка 4 курса **Факультета экономики, финансов и информационных технологий** (СПБГЭУ). Осваиваю backend-разработку на Python, фокус на надёжных и простых в сопровождении веб-сервисах. Интересуюсь Flask, тестированием и прикладными алгоритмами. Ищу стажировку или junior-позицию, где смогу расти под менторством и приносить пользу команде.
