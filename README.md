...
<img src="https://img.shields.io/badge/Requests-3670A0?style=for-the-badge&logo=python&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Seaborn-3c96d3?style=for-the-badge"/>

<!-- Other -->
<img src="https://img.shields.io/badge/Excel-217346?style=for-the-badge&logo=microsoft-excel&logoColor=white"/>
<img src="https://img.shields.io/badge/English-Upper--Intermediate-1DA1F2?style=for-the-badge"/>
...
**Магистратура (2026 — н.в.)**  
Университет ИТМО, Факультет технологий искусственного интеллекта  
**Направление:** «Искусственный интеллект и поведенческая экономика»  
1 курс
...
**NOVA — стажировка ГСП ЦР, 2026**  
Разработка Streamlit-приложения для автоматизации анализа документов с использованием LLM. Работа с Qwen, промптами, контекстным окном, чанкингом и многоэтапной обработкой документов.

**ООО «Газпром ПХГ» — производственная практика / дипломный проект, 2026**  
Разработка модели оптимального распределения инженерно-технических работ между подразделениями. Python, математическая оптимизация, HiGHS, OR-Tools CP-SAT.
